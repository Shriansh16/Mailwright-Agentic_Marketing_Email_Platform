...
# Override sqlalchemy.url from the environment so alembic.ini's
# hardcoded value is never used.
_db_url = os.environ.get("DATABASE_URL") or os.environ.get("LANGGRAPH_CHECKPOINTER_DB_URL")
if _db_url:
    # Alembic needs a synchronous driver — strip "+asyncpg" if present
